export function GallerySection({ items }) {
  return <section className="work-section container" id="work">
    <div className="work-heading"><div><h2 className="font-space font-extrabold text-4xl md:text-5xl lg:text-6xl uppercase tracking-[0.02em] text-black">GALLERY</h2></div></div>
